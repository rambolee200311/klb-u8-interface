...
namespace BidlinkU8Interface.Helper
{
    public class Log
    {
        ...
        //私有成员
        private static int Level;//日志等级,默认只输出错误
        ...
        static Log()
        {
            string LogPath = HOTConfig.GetConfig().GetLogPath();
            string SystemName = "U8Interface";
            int Loglevel = HOTConfig.GetConfig().GetLogLevel();
        ...
        private static void createLog(string LogPath, string SystemName, int LogLevel)
        {
